        ...
        class SMEA(scripts.Script):
            ...
            def __init__(self):
                if not smea.INITIALIZED:
                    samplers_smea = [
                        ("Spawner SMEA", sample_spawner_smea, ["k_spawner_smea"], {'scheduler': 'Simple', "uses_ensd": True}),
                        ("Spawner SMEA (beta)", sample_spawner_smea_beta, ["k_spawner_smea_beta"], {'scheduler': 'Simple', "uses_ensd": True}),
                        ("Spawner SMEA Dyn (beta)", sample_spawner_smea_dyn_beta, ["k_spawner_smea_dyn_beta"], {'scheduler': 'Simple',"uses_ensd": True}),
                    ]
                    samplers_data_smea = [
